        ...
        <section className="py-12 container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {versiculosAnteriores.map((versiculo) => (
              ...
              >
                {/* Aspas decorativas */}
                <div className="absolute top-3 right-6 sm:top-2 sm:right-6 text-primary/10 pointer-events-none">
        ...
        <div className="max-w-3xl mx-auto bg-gradient-to-br from-[hsl(220,70%,45%)] to-[hsl(220,70%,35%)] rounded-2xl shadow-medium p-8 md:p-12 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            >
              ...
              <p className="text-black">Seguir no Facebook</p>
              <ArrowRight className="w-4 h-4 text-black group-hover:translate-x-1 transition-transform" aria-hidden="true" />
            </a>
